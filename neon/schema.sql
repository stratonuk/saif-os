...
-- Weekly schedule: recurring blocks + dated entries
...
create index schedule_blocks_user_id_idx on public.schedule_blocks (user_id);
create index schedule_blocks_user_day_idx on public.schedule_blocks (user_id, day_of_week);
...
create index schedule_holidays_user_id_idx on public.schedule_holidays (user_id);
create index schedule_holidays_user_start_idx on public.schedule_holidays (user_id, start_date);

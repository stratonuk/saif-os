    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          />
          <div className="absolute bottom-0 left-0 right-0 max-h-[80vh] overflow-y-auto rounded-t-2xl border-t border-border/50 glass-strong p-4 pb-8 animate-in slide-in-from-bottom duration-300">
